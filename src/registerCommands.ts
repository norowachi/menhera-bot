...
const commands: ApplicationCommandData[] = [
	...
	{
		name: "custom",
		description: "manage custom responses",
		options: [
			{
				name: "add",
				...
				options: [
					...
					},
					{
						name: "reaction",
						description:
							"Reaction (id for custom) to add to the message containing the keyword",
						type: ApplicationCommandOptionType.String,
					},
					{
						name: "message",
						description:
							"Message to reply with to the message that conatins the keyword",
						type: ApplicationCommandOptionType.String,
					},
				],
			},
			{
				...
				options: [
					{
						name: "id",
						description: "id of the custom response",
						type: ApplicationCommandOptionType.String,
						required: true,
					},
				],
